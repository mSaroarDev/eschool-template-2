            ...
            <div className="border border-gray-500 overflow-hidden mt-2">
              ...
              <div className="p-5 bg-custom text-[17px] text-justify">
                <p className="text-center">
                  ( <span className="text-red-500">*</span> ) চিহ্নিত ঘরগুলো
                  অবশ্য পুরনীয়। <br /> শিক্ষার্থীর ছবির ক্ষেত্রে ৩০০x৩০০ পিক্সেল
                  এবং ছবির সর্বোচ্চ সাইজ ১০০ কিলোবাইট এর মধ্যে হতে হবে। <br />{" "}
                  এবং স্বাক্ষর এর ক্ষেত্রে ৩০০x৮০ পিক্সেল এবং ছবির সর্বোচ্চ সাইজ
                  ৬০ কিলোবাইট এর মধ্যে হতে হবে।
                </p>
