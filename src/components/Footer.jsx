  ...
  return (
    ...
    <div className=" bg-body">
        ...
        <footer className="footer p-10">
            <nav>
                <h6 className="footer-title">সার্ভিস</h6>
                <a className="link link-hover">পাঠদান</a>
                <a className="link link-hover">গননা</a>
                <a className="link link-hover">ক্রীড়া</a>
            </nav>
            <nav>
            ...
            <nav>
                ...
                <a className="link link-hover">ভর্তির নীতিমালা</a>
                <a className="link link-hover">প্রাইভেসি পলিসি</a>
                <a className="link link-hover">শিক্ষা পদ্ধতি</a>
